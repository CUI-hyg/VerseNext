...
class CometSparkSmallLM(CometSparkV05LM):
    ...
    # 覆盖父类 _config_class，使 from_pretrained / load_vn 用 Small 配置（保留 VMPC 字段）
    _config_class = CometSparkSmallConfig
    ...
    # ------------------------------------------------------------------
    # from_pretrained / load_vn：继承父类健壮实现（通过 _config_class 用 Small 配置）
