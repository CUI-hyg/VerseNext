...
class TestNewNNComponents(unittest.TestCase):
    ...
    def test_rotary_embedding_shape(self):
        ...
        from verse_torch.vnnn import RotaryEmbedding
    ...
    def test_kvcache_is_abstract(self):
        ...
        from verse_torch.vnnn import KVCache
        cache = KVCache()
    ...
    def test_static_cache_basic(self):
        """StaticCache 基本读写。"""
        from verse_torch.vnnn import StaticCache
    ...
    def test_dynamic_cache_basic(self):
        """DynamicCache 基本追加读写。"""
        from verse_torch.vnnn import DynamicCache
        cache = DynamicCache()
    ...
    def test_groupnorm_shape(self):
        ...
        from verse_torch.vnnn import GroupNorm
    ...
    def test_conv1d_shape(self):
        ...
        from verse_torch.vnnn import Conv1d
    ...
    def test_layernorm_fast_shape(self):
        ...
        from verse_torch.vnnn import LayerNormFast
    ...
    def test_layernorm_fast_matches_layernorm(self):
        ...
        from verse_torch.vnnn import LayerNorm, LayerNormFast
        np.random.seed(42)
